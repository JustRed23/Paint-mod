...
import dev.JustRed23.paint.particle.paint.PaintParticleType;
...
public final class ModParticles {
    ...
    private static final DeferredRegister<ParticleType<?>> PARTICLE_TYPES = DeferredRegister.create(ForgeRegistries.PARTICLE_TYPES, Paint.MOD_ID);
